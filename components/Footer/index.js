      ...
      <Animatify>
        <div className="relative max-w-screen-xl w-full mx-auto mt-10">
            ...
            <div className="">
              ...
              <div className="flex justify-start items-center gap-6 h-fit mt-6">
                ...
                <a
                  ...
                  href="https://github.com/Chetanshrivas"
                  target="_blank"
                  rel="noreferrer"
                >
                  <FiGithub />
                ...
                <a
                  className="text-lightTextColor dark:text-white text-3xl w-fit inline "
                  href="https://www.linkedin.com/in/chetan-shrivas/"
                  target="_blank"
                  rel="noreferrer"
                >
                  <FiLinkedin />
                ...
                <a
                  className="text-lightTextColor dark:text-white text-3xl w-fit inline "
                  href="mailto:chetanshrivas1234@gmail.com"
                  target="_blank"
                  rel="noreferrer"
                >
                  <FiMail />
          ...
          <div className="text-lightTextColor dark:text-white text-lg text-center pb-6">
            © {new Date().getFullYear()} <span className="text-green-400">Chetan shrivas.</span> All rights reserved.
          </div>
        </div>
      </Animatify>
    </div>
